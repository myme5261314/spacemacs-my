...
values."
  (setq-default
   ...
   '(html
     ...
     ranger
     gtags
     (spacemacs-layouts :variables layouts-enable-autosave
                        t layouts-autosave-delay 300)
     (colors :variables colors-enable-nyan-cat-progress-bar
             t)
     (git :variables git-magit-status-fullscreen
          t magit-push-always-verify nil magit-save-repository-buffers
          'dontask magit-revert-buffers 'silent magit-refs-show-commit-count
          'all)
     ;; This is really creepy magit magit-revision-show-gravatars
     ...
     (shell :variables shell-default-position'full
            shell-default-shell 'ansi-term shell-default-term-shell
            "/bin/zsh")
     (chinese :variables chinese-default-input-method'wubi
              chinese-enable-fcitx t chinese-enable-youdao-dict
              t)
     my)
...
values."
  ...
  (setq-default
   ...
   ;; when the current branch is not `develop'. (default t) dotspacemacs-check-for-update t
   ...
   dotspacemacs-themes
   '(spacemacs-dark solarized-dark monokai)
